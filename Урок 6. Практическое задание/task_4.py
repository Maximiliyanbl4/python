...
class Car:
    ...
    def show_speed(self):
        return f"\nТекущую скорость автомобиля {self.speed} км\ч"
...
class TownCar(Car):
    def show_speed(self):
        if self.speed > 60:
            ...
            return f"Скорость автомобиля - {self.name} внорме"
...
class WorkCar(Car):
    def show_speed(self):
        if self.speed > 40:
            ...
            return f"\nСкорость автомобиля - {self.name} внорме"
